...
public class updateStudent extends javax.swing.JFrame {
    ...
    String connect = "jdbc:mysql://localhost/school";
    ...
    private void initComponents() {
        ...
        jPanel2.add(cmbClass, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 200, 240, -1));
        ...
        jLabel9.setText("صنف:");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 200, -1, 20));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (21).jpeg"))); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            d.connect();
            d.update("UPDATE student SET fullname='" + fullName + "', fathername='" + fatherName + "', gfathername='" + gfatherName + "', gender='" + gender + "', dob='" + dob + "', class_id=" + class_id + ", date='" + date + "', phone='" + phone + "', address='" + address + "' WHERE student_id= " + allStudent.sid);
            this.setVisible(false);
            new allStudent().setVisible(true);
        } catch (Exception e) {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT student_id, fullname, fathername, gfathername, gender, dob, class_id, class_grade, date, phone, address FROM student JOIN class USING(class_id) WHERE student_id = " + allStudent.sid);
            rs.next();
