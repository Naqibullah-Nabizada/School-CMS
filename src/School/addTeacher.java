...
public class addTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (24).jpeg"))); // NOI18N
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            ...
            d.connect();
            d.insert("INSERT INTO teacher VALUES (NULL, '"+fullName+"', '"+fatherName+"', '"+gfatherName+"', '"+gender+"', '"+dob+"', '"+position+"', '"+date+"', '"+phone+"', '"+address+"')");
