...
public class allClass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ClassTable.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 300, 400));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (48).jpeg"))); // NOI18N
        jLabel13.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 400));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("لیست صنوف لیسه عالی خصوصی بروت");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            cid = Integer.parseInt(ClassTable.getValueAt(ClassTable.getSelectedRow(), 0).toString());

            d.connect();
            int mes = JOptionPane.showConfirmDialog(null, "آیا موافق هستید این ریکورد حذف شود؟");
            if (mes == 0) {
                d.delete("DELETE FROM class WHERE class_id = " + cid);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            d.connect();
            String[][] classes = d.select("SELECT * FROM class");
            String[] columns = {"شماره", "صنف", "فیس"};
            ClassTable = new JTable(classes, columns);
            jScrollPane1.setViewportView(ClassTable);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allClass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
