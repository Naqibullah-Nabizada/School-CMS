...
public class addSubject extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("مضمون:");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 120, 60, 20));

        txtSubject.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        txtSubject.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        jPanel2.add(txtSubject, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 120, 240, -1));
        ...
        jPanel2.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 210, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel4.setText("صنف:");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 160, 60, 20));
        ...
        jPanel2.add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 210, 70, -1));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (4).jpeg"))); // NOI18N
        ...
        jPanel2.add(cmbClass, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 160, 160, -1));
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            ...
            d.connect();
            d.insert("INSERT INTO subject VALUES (NULL, '"+subject+"', "+class_id+")");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try{
            ...
            for (int i=0; i<Class.length; i++){
                cmbClass.addItem(Class[i][0]+"- "+Class[i][1]);
            }
        }catch(Exception e){
