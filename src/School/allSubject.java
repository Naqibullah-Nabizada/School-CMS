...
public class allSubject extends javax.swing.JFrame {

    DAL d = new DAL();
    public static int subid;
    /**
     * Creates new form allSubject
     */
    public allSubject() {
        initComponents();
    }
    ...
    private void initComponents() {
		...
		for (int i=0; i<3; i++){
			...
			subjectTable.getColumnModel().getColumn(i).setCellRenderer(rightRenderer);
        ...
        subjectTable.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 0, 260, 400));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (5).jpeg"))); // NOI18N
        jLabel13.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 400));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try{
            d.connect();
            String[][] subject = d.select("SELECT sub_id, sub_name, class_grade FROM subject INNER JOIN class USING(class_id)");
            String[] column = {"شماره", "مضمون", "صنف"};
            subjectTable = new JTable(subject, column);
            jScrollPane1.setViewportView(subjectTable);
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("لیست مضامین لیسه عالی خصوصی بروت");
            MessageFormat footer = new MessageFormat(date.toString());
            subjectTable.print(JTable.PrintMode.FIT_WIDTH, header, footer);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            subid = Integer.parseInt(subjectTable.getValueAt(subjectTable.getSelectedRow(), 0).toString());

            d.connect();
            int mes = JOptionPane.showConfirmDialog(null, "آیا موافق هستید این ریکورد حذف شود؟");
            if (mes == 0) {
                d.delete("DELETE FROM subject WHERE sub_id = " + subid);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allSubject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new allSubject().setVisible(true);
            }
        });
    }
