...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(cmbClass, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 200, 140, -1));
        ...
        jPanel2.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 360, -1, -1));
        ...
        jPanel2.add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 360, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (23).jpeg"))); // NOI18N
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            ...
            d.connect();
            d.insert("INSERT INTO student VALUES (NULL, '"+fullName+"', '"+fatherName+"', '"+gfatherName+"', '"+gender+"', '"+dob+"', "+class_id+", '"+date+"', '"+phone+"', '"+address+"')");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for (int i=0; i<classes.length; i++){
            cmbClass.addItem(classes[i][0]+"- "+classes[i][1]);
        }
