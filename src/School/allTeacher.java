...
public class allTeacher extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		TeacherTable.setFont(new java.awt.Font("Tahoma", 0, 12));
		...
		for (int i=0; i<10; i++){
			...
			TeacherTable.getColumnModel().getColumn(i).setCellRenderer(rightRenderer);
			
		}
		
		TeacherTable.getColumnModel().getColumn(0).setPreferredWidth(35);
		TeacherTable.getColumnModel().getColumn(1).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(2).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(3).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(4).setPreferredWidth(35);
		TeacherTable.getColumnModel().getColumn(5).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(6).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(7).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(8).setPreferredWidth(60);
		TeacherTable.getColumnModel().getColumn(9).setPreferredWidth(70);
            }
        });
        ...
        TeacherTable.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        TeacherTable.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jScrollPane1.setViewportView(TeacherTable);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 400));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("لیست اساتید لیسه عالی خصوصی بروت");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            d.connect();
            String[][] student = d.select("SELECT * FROM teacher");
            String[] column = {"شماره", "نام", "نام پدر", "نام پدرکلان", "جنسیت", "تاریخ تولد", "درجه تحصیل", "تاریخ", "موبایل", "نشانی"};
            
            TeacherTable = new JTable(student, column);
            jScrollPane1.setViewportView(TeacherTable);
