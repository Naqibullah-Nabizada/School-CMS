...
public class allScore extends javax.swing.JFrame {
    ...
    private void initComponents() {
		...
		for (int i=0; i<8; i++){
			...
			scoreTable.getColumnModel().getColumn(i).setCellRenderer(rightRenderer);
			
		}	
		
		scoreTable.getColumnModel().getColumn(0).setPreferredWidth(35);
		scoreTable.getColumnModel().getColumn(1).setPreferredWidth(30);
		scoreTable.getColumnModel().getColumn(2).setPreferredWidth(40);
		scoreTable.getColumnModel().getColumn(3).setPreferredWidth(40);
		scoreTable.getColumnModel().getColumn(4).setPreferredWidth(50);
		scoreTable.getColumnModel().getColumn(5).setPreferredWidth(50);
		scoreTable.getColumnModel().getColumn(6).setPreferredWidth(35);
		scoreTable.getColumnModel().getColumn(7).setPreferredWidth(30);
            }
        });
        ...
        scoreTable.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        scoreTable.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 460, 400));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (23).jpeg"))); // NOI18N
        jLabel13.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 410, 400));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        try {
            ...
            MessageFormat header = new MessageFormat("لیست نمرات لیسه عالی خصوصی بروت");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            scoreId = Integer.parseInt(scoreTable.getValueAt(scoreTable.getSelectedRow(), 0).toString());

            d.connect();
            int mes = JOptionPane.showConfirmDialog(null, "آیا موافق هستید این ریکورد حذف شود؟");
            if (mes == 0) {
                d.delete("DELETE FROM score WHERE score_id = " + scoreId);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try{
            ...
            String[][] score = d.select("SELECT score_id, class_grade, fullname, fathername, gfathername, sub_name, exam, score FROM score JOIN class USING(class_id) JOIN student USING(student_id) JOIN subject USING(sub_id)");
            String[] column = {"شماره", "صنف", "نام", "نام پدر", "نام پدرکلان", "مضمون", "امتحان", "نمره"};
            scoreTable = new JTable(score, column);
            jScrollPane1.setViewportView(scoreTable);
