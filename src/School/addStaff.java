...
public class addStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 380, -1, -1));
        ...
        jPanel2.add(btnRegister, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 380, -1, -1));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/img (29).jpeg"))); // NOI18N
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        try{
            ...
            d.connect();
            d.insert("INSERT INTO staff VALUES (NULL, '"+fullName+"', '"+fatherName+"', '"+gfatherName+"', '"+gender+"', '"+dob+"', '"+post+"', "+salary+",'"+date+"', '"+phone+"', '"+address+"')");
